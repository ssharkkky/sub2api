...
export interface DeploymentJob {
  ...
  control_plane_upgrade_status?: 'pending' | 'retrying' | 'succeeded' | 'failed' | 'skipped' | 'unknown'
  control_plane_upgrade_error?: string
  control_plane_upgrade_attempt?: number
  control_plane_upgrade_max_attempts?: number
  control_plane_upgrade_next_attempt_at?: string
  created_at: string
  started_at: string
  updated_at: string
  finished_at?: string
