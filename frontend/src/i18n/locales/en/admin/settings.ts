export default {
    settings: {
      ...
      payment: {
        ...
        refundResultUserEmailHint: 'Notify users after a refund succeeds, reaches a terminal failure, or an administrator rejects the request; the User Refund Notifications master switch in Email Settings must also be enabled',
        easypayAutoReconcile: 'EasyPay Active Reconciliation',
        easypayAutoReconcileHint: 'Query pending EasyPay orders every minute so missed callbacks can still be credited. Disabling this keeps callbacks and browser-return checks active',
      ...
      emailPolicy: {
        ...
        recipientGroupsHint: 'These addresses receive account quota, refund review, and Ops mail. Only groups used by a current mail channel are shown.',
        userPrimary: 'Send to account email',
        userPrimaryHint: 'The primary address used for the user account.',
        verifiedAdditional: 'Also send to verified backup notification emails',
        verifiedAdditionalHint: 'Additional addresses the user added in Profile, verified, and has not disabled.',
        userAccountEmailRecipient: "Sends to the related user's account email",
        ...
        balanceRecipientSummary: "Sends to the user's account email and/or verified backup notification emails",
        userPrimaryRecipientSummary: "Sends to the related user's account email",
        explicitRecipientSummary: 'Codes and links only go to the address supplied by the current action',
        addRecipient: 'Add recipient',
        addToAllGroups: 'Add to all recipient groups',
        bulkEmailPlaceholder: "Enter one admin email, for example admin{'@'}example.com",
        addedToAllGroups: 'Added to all admin recipient groups; save to apply',
        invalidEmail: 'Enter a valid admin email address',
        recipientGroupFull: '“{group}” can contain at most 20 recipients',
        balanceRecipientRequired: 'Select the account email or verified backup emails when balance notifications are enabled',
        ...
        balanceLow: {
          title: 'Low balance reminders',
          hint: 'Sends once when balance crosses below the threshold. Recharge success mail remains controlled by the Balance Email master switch.',
          threshold: 'Reminder threshold (USD)',
          thresholdRequired: 'The reminder threshold must be greater than 0 when low balance reminders are enabled',
          rechargeURL: 'Recharge page URL (optional)',
          invalidRechargeURL: 'The recharge page URL must be a complete HTTP or HTTPS URL'
        },
        channels: {
