export default {
    ...
    users: {
      ...
      totalBalance: 'All User Balances',
      totalBalanceHint: 'Total available balance across all non-deleted users, unaffected by the current search, filters, or page.',
      bulkLimits: {
    ...
    groups: {
      ...
      modelsList: {
        ...
        hint: 'Only changes the {endpoint} response. Whitelist model calls and account routing are unchanged.',        loading: 'Loading model list...',
