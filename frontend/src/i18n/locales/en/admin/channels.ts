export default {
    ...
    channels: {
      ...
      form: {
        ...
        tierMultiplierHint: 'Overrides the channel service-tier defaults above. Leave empty to use the channel default, then the catalog price.',
        maxReasoningEffortMultiplier: 'Max Effort Multiplier',
        fable51DefaultMaxReasoningMultiplier: 'Default: 3',        multiplierPlaceholder: 'Not set',
        ...
        serviceTiers: 'OpenAI Service Tiers',
        serviceTiersHint: 'Choose which service tiers this channel offers and set default billing multipliers relative to the Standard base price. Per-model Fast/Flex multipliers override these defaults.',
        serviceTierStandard: 'Standard',
        serviceTierStandardHint: 'Regular requests and requests that omit service_tier.',
        serviceTierPriority: 'Fast / Priority',
        serviceTierPriorityHint: 'The fast alias is normalized to priority before the request is sent upstream.',
        serviceTierFlex: 'Flex',
        serviceTierFlexHint: 'Availability still depends on the final upstream model and account.',
        serviceTierMultiplier: '{tier} billing multiplier',
        serviceTierConfigInvalid: 'The saved service tier configuration is invalid. Correct it and save again.',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        apiKeyProviderChangeRequired: 'Provide a new API key after changing platform.',
        apiKeyProviderChangeHint: 'Enter a new key for an external upstream. For a local Antigravity group, use “Use my key” so the dedicated route is applied automatically.',
        useMyKey: 'Use my key',
