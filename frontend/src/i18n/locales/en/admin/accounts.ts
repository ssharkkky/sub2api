export default {
    accounts: {
      ...
      mapRequestModels:
        'Rename request models only. Unmapped names still pass through. Left is the requested model, right is the upstream model.',
      ...
      refreshUpstreamModels: 'Refresh upstream models',
      refreshUpstreamModelsSuccess: 'Refreshed {count} upstream model(s)',
      ...
      upstreamModelCapabilitiesTitle: 'Models actually supported upstream',
      upstreamModelCapabilitiesHint: 'The system syncs these automatically. They show account capability only and do not change the mappings below.',
