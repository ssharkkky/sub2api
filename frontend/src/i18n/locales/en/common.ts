export default {
  common: {
    ...
    customerServiceDescription: 'Scan a QR code or open a link to contact us',
    closeCustomerService: 'Close online support',
    afterSalesSupport: 'Customer Service',
    officialGroup: 'Official Group',
    openSupportLink: 'Open support link',
    openGroupLink: 'Join official group',
    add: 'Add',
  ...
  auth: {
    ...
    promoCodeLabel: 'Promo or Referral Code',
    promoCodePlaceholder: 'Enter a promo or referral code',
    promoCodeValid: 'Valid! You will receive ${amount} bonus balance',
    affiliateCodeValid: 'Referral code is valid',
    promoAffiliateCodeValid: 'Valid! You will receive ${amount} and the referral will be linked',
    promoCodeInvalid: 'Invalid promo or referral code',
    promoCodeNotFound: 'Promo or referral code not found',
    ...
    promoCodeValidating: 'Code is being validated, please wait',
    promoCodeInvalidCannotRegister: 'Invalid code. Please check and try again or clear the code field',
