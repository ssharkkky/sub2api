export default {
  common: {
    ...
    customerServiceDescription: '扫码或点击链接联系我们',
    closeCustomerService: '关闭在线客服',
    afterSalesSupport: '售后客服',
    officialGroup: '官方群组',
    openSupportLink: '打开客服链接',
    openGroupLink: '加入官方群组',
    add: '添加',
  ...
  auth: {
    ...
    promoCodeLabel: '优惠码 / 返利邀请码',
    promoCodePlaceholder: '请输入优惠码或返利邀请码',
    promoCodeValid: '有效！注册后将获得 ${amount} 赠送余额',
    affiliateCodeValid: '返利邀请码有效',
    promoAffiliateCodeValid: '有效！注册后将获得 ${amount} 赠送余额并绑定返利关系',
    promoCodeInvalid: '无效的优惠码或返利邀请码',
    promoCodeNotFound: '优惠码或返利邀请码不存在',
    promoCodeExpired: '此优惠码已过期',
    promoCodeDisabled: '此优惠码已被禁用',
    promoCodeMaxUsed: '此优惠码已达到使用上限',
    promoCodeAlreadyUsed: '您已使用过此优惠码',
    promoCodeValidating: '代码正在验证中，请稍候',
    promoCodeInvalidCannotRegister: '代码无效，请检查后重试或清空输入框',
