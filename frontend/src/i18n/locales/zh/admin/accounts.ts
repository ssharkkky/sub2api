export default {
    accounts: {
      ...
      refreshUpstreamModels: '刷新上游模型列表',
      refreshUpstreamModelsSuccess: '已刷新上游模型列表，共 {count} 个',
      ...
      upstreamModelCapabilitiesTitle: '上游实际支持模型',
      upstreamModelCapabilitiesHint: '系统会自动从上游同步；这里只展示账号实际能力，不会改写下面的模型映射。',
