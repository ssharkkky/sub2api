export default {
    ops: {
      ...
      healthBreakdown: {
        ...
        footer: '扣分明细与页面分数来自后端同一次计算；管理员主动停用的可选任务不参与扣分。',
      ...
      alertRules: {
        ...
        metrics: {
		  ...
		  platformCredentialFailureCount: '托管凭据失败数',
        ...
        metricDescriptions: {
		  ...
		  platformCredentialFailureCount: '托管账号令牌、OAuth 凭据或账号认证失效导致的失败数。',
		  ...
		  ttftP95: '统计窗口内有首字记录请求的 P95 首字延迟，单位为秒。',
		  ttftP99: '统计窗口内有首字记录请求的 P99 首字延迟，单位为秒。',
		  ttftMax: '统计窗口内单条请求的最大首字延迟，单位为秒；建议配合最小样本数避免低流量误报。',
      ...
      realtime: {
        title: '实时信息',
		actualDeduction: '用户实际扣款',
		windowTotal: '{window} 真实数据',
		noChartData: '当前窗口暂无数据',
        connected: '实时已连接',
        connecting: '实时连接中',
        reconnecting: '实时重连中',
        offline: '实时离线',
      ...
      tooltips: {
        ...
        throughputTrend: '当前窗口内的请求 RPM 与 K TPS 趋势。',
        ...
        qps: '每分钟请求数（RPM）和每秒千 Token 数（K TPS），实时显示系统吞吐量。',
