<template>
  <header class="sticky top-0 z-30 border-b border-gray-200 bg-white/95 backdrop-blur-md dark:border-dark-700 dark:bg-dark-950/95">
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-1 sm:gap-3">
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-lg border border-gray-200 bg-white px-3 py-1.5 dark:border-dark-700 dark:bg-dark-900 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-gray-900 text-sm font-medium text-white dark:bg-white dark:text-gray-950">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
