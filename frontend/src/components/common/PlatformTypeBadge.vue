...
const privacyBadge = computed(() => {
  ...
  switch (props.privacyMode) {
    // OpenAI states
    case 'training_off':
      return { label: 'Private', icon: shieldCheck, title: t('admin.accounts.privacyTrainingOff'), class: 'bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-400' }
    ...
    // Antigravity states
    case 'privacy_set':
      return { label: 'Private', icon: shieldCheck, title: t('admin.accounts.privacyAntigravitySet'), class: 'bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-400' }
