...
describe('feature route guard', () => {
  ...
  it('allows the image playground only when its opt-in switch is enabled', async () => {
  ...
  it('redirects direct image playground access when the switch is disabled', async () => {
