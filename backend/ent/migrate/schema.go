...
var (
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "grok", "antigravity", "kiro", "kimi", "zhipu", "deepseek", "minimax", "opencode_go"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "fallback_group_id_on_prompt_audit_block", Type: field.TypeInt64, Nullable: true},
		...
		{Name: "allow_live", Type: field.TypeBool, Nullable: true, Default: false},
