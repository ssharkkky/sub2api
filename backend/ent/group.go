...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldFallbackGroupIDOnPromptAuditBlock, group.FieldSortOrder, group.FieldRpmLimit, group.FieldKiroStickySessionTTLSeconds:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldFallbackGroupIDOnPromptAuditBlock:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field fallback_group_id_on_prompt_audit_block", values[i])
			} else if value.Valid {
				_m.FallbackGroupIDOnPromptAuditBlock = new(int64)
				*_m.FallbackGroupIDOnPromptAuditBlock = value.Int64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	if v := _m.FallbackGroupIDOnPromptAuditBlock; v != nil {
		builder.WriteString("fallback_group_id_on_prompt_audit_block=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
