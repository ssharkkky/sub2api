...
func TestChannelMonitorV2DateBinOriginMatchesUnixEpochUTC(t *testing.T) {
	require.Equal(t, "date_bin($1::interval,m.bucket_start,TIMESTAMPTZ '1970-01-01 00:00:00+00')", channelMonitorV2DateBinExpr("m.bucket_start"))
	require.Equal(t, "date_bin($1::interval,h.bucket_start,TIMESTAMPTZ '1970-01-01 00:00:00+00')", channelMonitorV2DateBinExpr("h.bucket_start"))
	require.Equal(t, "date_bin($1::interval,e.bucket_start,TIMESTAMPTZ '1970-01-01 00:00:00+00')", channelMonitorV2DateBinExpr("e.bucket_start"))
	require.NotRegexp(t, `TIMESTAMPTZ '1970-01-01'`, channelMonitorV2DateBinExpr("m.bucket_start"))
