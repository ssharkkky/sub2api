...
func registerPromptAuditRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	promptAudit := admin.Group("/prompt-audit")
	{
		...
		promptAudit.DELETE("/hashes", h.Admin.PromptAudit.DeleteFlaggedHash)
		promptAudit.DELETE("/hashes/all", h.Admin.PromptAudit.ClearFlaggedHashes)
...
func registerSystemRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	system := admin.Group("/system")
	{
		...
		system.GET("/deployment-jobs/current", h.Admin.System.GetCurrentDeploymentJob)
		system.GET("/deployment-jobs/:id", h.Admin.System.GetDeploymentJob)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.GET("/catalog-models", h.Admin.Channel.ListCatalogModels)
