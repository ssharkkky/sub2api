...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		gateway.GET("/images/tasks/:task_id/images/:image_index", h.AsyncImage.GetImage)
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, handler)
	}
	...
	rootRoute(http.MethodGet, "/images/tasks/:task_id/images/:image_index", bodyLimit, h.AsyncImage.GetImage)
