...
func RegisterGatewayRoutes(
	...
	r.GET("/images/tasks/:task_id/images/:image_index", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), compositeTarget, requireGroupAnthropic, h.AsyncImage.GetImage)
