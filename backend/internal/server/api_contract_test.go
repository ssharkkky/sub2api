		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"after_sales_title": "VIP Support",
					"after_sales_qrcode": "",
					"after_sales_link": "",
					"after_sales_link_label": "Start a chat",
					"official_group_title": "Community",
					"official_group_qrcode": "",
					"official_group_link": "",
					"official_group_link_label": "Join now",
					"customer_service_text_enabled": true,
					"customer_service_text": "Support hours",
