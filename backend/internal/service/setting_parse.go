...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyCustomerServiceEnabled:                    "true",
		SettingKeyCustomerServiceTextEnabled:                "false",
		...
		// Image playground feature (default disabled; opt-in)
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		AfterSalesLink:                         settings[SettingKeyAfterSalesLink],
		...
		OfficialGroupQRCode:                    settings[SettingKeyOfficialGroupQRCode],
		OfficialGroupLink:                      settings[SettingKeyOfficialGroupLink],
	...
	// Image playground feature (default: disabled; strict true)
	result.ImagePlaygroundEnabled = settings[SettingKeyImagePlaygroundEnabled] == "true"
