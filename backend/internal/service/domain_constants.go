...
const (
	...
	SettingKeyAfterSalesTitle             = "after_sales_title"             // 售后客服卡片标题
	SettingKeyAfterSalesQRCode            = "after_sales_qrcode"            // 售后客服二维码
	SettingKeyAfterSalesLink              = "after_sales_link"              // 售后客服链接
	SettingKeyAfterSalesLinkLabel         = "after_sales_link_label"        // 售后客服链接文字
	SettingKeyOfficialGroupTitle          = "official_group_title"          // 官方群卡片标题
	...
	// SettingKeyImagePlaygroundEnabled controls the dashboard image playground.
	// The sidebar, route guard, and dashboard API all fail closed unless explicitly enabled.
