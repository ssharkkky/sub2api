...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	notificationEmailDeliveryRepository := repository.NewNotificationEmailDeliveryRepository(db)
	notificationEmailService := service.NewNotificationEmailService(settingRepository, emailService)
	secretEncryptor, err := repository.NewAESEncryptor(configConfig)
	if err != nil {
		return nil, err
	}
	notificationEmailDispatcher := service.ProvideNotificationEmailDispatcher(notificationEmailDeliveryRepository, notificationEmailService, secretEncryptor, configConfig)
	emailQueueService := service.ProvideEmailQueueService(emailService, notificationEmailDispatcher)
	...
	userService := service.ProvideUserService(userRepository, settingRepository, apiKeyAuthCacheInvalidator, billingCache, notificationEmailDispatcher)
	...
	channelService := service.ProvideChannelService(channelRepository, groupRepository, apiKeyAuthCacheInvalidator, pricingService, accountRepository, channelCachePubSub)
	...
	balanceNotifyService := service.ProvideBalanceNotifyService(emailService, settingRepository, accountRepository, notificationEmailService, notificationEmailDispatcher)
	gatewayService := service.NewGatewayService(accountRepository, groupRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, identityService, httpUpstream, deferredService, claudeTokenProvider, kiroTokenProvider, kiroCooldownStore, sessionLimitCache, rpmCache, digestSessionStore, settingService, tlsFingerprintProfileService, channelService, modelPricingResolver, compositeRouteResolver, balanceNotifyService, serviceUserPlatformQuotaRepository)
	...
	notificationEmailDeliveryWorker := service.ProvideNotificationEmailDeliveryWorker(notificationEmailDeliveryRepository, notificationEmailService, secretEncryptor, configConfig)
	opsService := service.ProvideOpsService(opsRepository, settingRepository, configConfig, accountRepository, userRepository, concurrencyService, gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, opsSystemLogSink, settingService, authCacheInvalidationWorker, notificationEmailDeliveryWorker, apiKeyService)
	...
	paymentService := service.ProvidePaymentService(client, registry, defaultLoadBalancer, redeemService, subscriptionService, paymentConfigService, userRepository, groupRepository, affiliateService, notificationEmailService, notificationEmailDispatcher)
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, aliyunCaptchaService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService, notificationEmailDispatcher, totpService, userService)
	...
	contentModerationService := service.ProvideContentModerationService(settingRepository, contentModerationRepository, contentModerationHashCache, groupRepository, userRepository, proxyRepository, apiKeyAuthCacheInvalidator, emailService, notificationEmailDispatcher)
	...
	openAICompatibleScanner := securityaudit.ProvideOpenAICompatibleScanner(proxyRepository)
	atomicMetrics := securityaudit.NewAtomicMetrics()
	promptAuditHashCache := securityaudit.NewRedisPromptAuditHashCache(redisClient)
	promptService := securityaudit.NewPromptService(configManager, postgreSQLRepository, redisPayloadStore, openAICompatibleScanner, atomicMetrics, promptAuditHashCache)
	...
	asyncImageHandler := handler.NewAsyncImageHandler(imageTaskService, openAIGatewayHandler, opsService)
	imagePlaygroundService := service.NewImagePlaygroundService(apiKeyService, gatewayService, imageTaskService, settingService)
	imagePlaygroundHandler := handler.NewImagePlaygroundHandler(imagePlaygroundService, imageTaskService, asyncImageHandler, userService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, imagePlaygroundHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
	...
	opsAlertEvaluatorService := service.ProvideOpsAlertEvaluatorService(opsService, opsRepository, notificationEmailDispatcher, redisClient, configConfig, proxyRepository)
	...
	opsScheduledReportService := service.ProvideOpsScheduledReportService(opsService, userService, notificationEmailDispatcher, redisClient, configConfig)
	...
	subscriptionExpiryService := service.ProvideSubscriptionExpiryService(userSubscriptionRepository, settingRepository, notificationEmailDispatcher, leaderLockCache, db)
	...
	upstreamCapabilitySyncService := service.ProvideUpstreamCapabilitySyncService(accountRepository, accountTestService, leaderLockCache, db)
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, notificationEmailDeliveryWorker, schedulerSnapshotService, concurrencyService, dashboardAggregationService, deferredService, userMessageQueueService, timingWheelService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, imageTaskService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, kiroOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, upstreamCapabilitySyncService, ollamaCloudUsageService, auditLogService, openAIQuotaAutoResetService, promptService, pluginManager)
