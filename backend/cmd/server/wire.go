...
func provideCleanup(
	...
	notificationEmailDeliveryWorker *service.NotificationEmailDeliveryWorker,
	...
	upstreamCapabilitySync *service.UpstreamCapabilitySyncService,
	...
	return func(ctx context.Context) {
		...
		parallelSteps := []cleanupStep{
			...
			{"NotificationEmailDeliveryWorker", func() error {
				if notificationEmailDeliveryWorker != nil {
					notificationEmailDeliveryWorker.Stop()
				}
				return nil
			}},
			...
			{"UpstreamCapabilitySyncService", func() error {
				if upstreamCapabilitySync != nil {
					upstreamCapabilitySync.Stop()
				}
				return nil
			}},
