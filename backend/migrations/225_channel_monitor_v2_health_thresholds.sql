...
ALTER TABLE channel_monitor_v2_config
    ADD COLUMN IF NOT EXISTS health_thresholds JSONB;

-- The repository already coalesces NULL for mixed-version reads. Backfill the
-- singleton row without adding a table-rewriting default or NOT NULL constraint.
...
SET health_thresholds = '{
      ...
      "ttft_weight": 0.20,
      "cache_weight": 0.20
    }'::jsonb || COALESCE(health_thresholds, '{}'::jsonb)
WHERE id = 1;
