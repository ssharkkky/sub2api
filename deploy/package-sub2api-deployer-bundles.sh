...
for arch in amd64 arm64; do
  ...
  for asset in compose.deployer.yml sub2api-deployer.service sub2api-deployer-upgrade.service sub2api-deployer-upgrade.timer sub2api-deployer-upgrade.sh sub2api-deployer-tmpfiles.conf sub2api-managed-upstream.conf; do
  ...
  (
    ...
    sha256sum \
      ...
      deploy/sub2api-deployer-upgrade.timer \
